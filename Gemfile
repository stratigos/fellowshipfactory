...
gem "bootsnap", "~> 1.24.3", require: false # Reduces boot times through caching; required in config/boot.rb
...
gem "thruster", "~> 0.1.20", require: false # Add HTTP asset caching/compression and X-Sendfile acceleration to Puma [https://github.com/basecamp/thruster/]
