...
gem "bootsnap", "~> 1.24.5", require: false # Reduces boot times through caching; required in config/boot.rb
...
gem "jbuilder", "~> 2.15.0"
gem "kamal", "~> 2.12.0", require: false # Deploy this application anywhere as a Docker container [https://kamal-deploy.org]
